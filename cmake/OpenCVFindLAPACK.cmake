...
macro(ocv_lapack_check)
  ...
  if (NOT OPENCV_LAPACKE_H_PATH_${_lapack_impl})
    _find_header_file_in_dirs(OPENCV_LAPACKE_H_PATH_${_lapack_impl} "${LAPACK_LAPACKE_H}")
  endif()
...
if(WITH_LAPACK)
  ...
  if(NOT OPENCV_LAPACK_FIND_PACKAGE_ONLY)
    ...
    if(NOT LAPACK_LIBRARIES AND UNIX)
        find_path(DEFAULT_BLAS_INCLUDE_DIR NAMES cblas.h)
        find_library(DEFAULT_BLAS_LIB NAMES blas)
        if(DEFAULT_BLAS_INCLUDE_DIR AND DEFAULT_BLAS_LIB)
            set(LAPACK_INCLUDE_DIR  ${DEFAULT_BLAS_INCLUDE_DIR})
            set(LAPACK_LIBRARIES    ${DEFAULT_BLAS_LIB})
            set(LAPACK_CBLAS_H      "cblas.h")
            set(LAPACK_LAPACKE_H    "lapacke.h")
            set(LAPACK_IMPL         "System default BLAS")
            ocv_lapack_check()
        endif()
    endif()
