...
typedef tuple<string, string> Param;
typedef testing::TestWithParam<Param> Videoio_Image_Test;

TEST_P(Videoio_Images_Test, Read_Write)
{
    // string write_pattern = get<0>(GetParam());
    // string read_pattern  = get<1>(GetParam());
    // const int count_frames = 10;
    //
    // VideoWriter wri(write_pattern, CAP_IMAGES);
    //
    // VideoCapture cap(read_pattern, CAP_IMAGES);
...
// };
//
// INSTANTIATE_TEST_CASE_P(videoio, Videoio_Images_Test, testing::ValuesIn(test_data));
